...
image = Image.open('C:\\Users\\riya.anadani\\Downloads\\SnowGov.png')
...
def monitor3():
    ...
    # Sidebar with Environment, Project, and Subject Area dropdowns
    ...
    df_credits = df_credits.sort_values(by='Credits', ascending=False)
    ...
    # Add a predefined date range picker to the sidebar
